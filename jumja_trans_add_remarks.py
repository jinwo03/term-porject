...
#disunite consonant and vowel
jamo_str = j2hcj(h2j(text))

#translate letters into braille. It starts from top right to bottom left 
...
#write dots into braille codes translated
